...
class scrap_widget_post_grid extends Widget_Base {
    ...
    public function get_name() {
        return 'scrap-post-grid';
    }

    public function get_title() {
        return esc_html__( 'Posts Grid', 'scrap' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'options'   =>  [
                    ...
                    'author'        =>  esc_html__( 'Post Author', 'scrap' ),
        ...
        $this->start_controls_section(
            'content_layout',
            [
                'label' => esc_html__( 'Layout Settings', 'scrap' ),
                'tab' => Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $this->add_control(
            'column_number',
            [
                'label'     =>  esc_html__( 'Column', 'scrap' ),
                'type'      =>  Controls_Manager::SELECT,
                'default'   =>  3,
                'options'   =>  [
                    1   =>  esc_html__( '1 Column', 'scrap' ),
                    2   =>  esc_html__( '2 Column', 'scrap' ),
                    3   =>  esc_html__( '3 Column', 'scrap' ),
                    4   =>  esc_html__( '4 Column', 'scrap' ),
                ],
            ]
        );
...
Plugin::instance()->widgets_manager->register_widget_type( new scrap_widget_post_grid );